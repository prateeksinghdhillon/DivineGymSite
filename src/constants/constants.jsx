const sections = [
  {
    ...
    title: "PERFORMANCE",
    content: (
      <div className=" text-black  flex flex-col md:flex-row gap-10 text-nowrap bg-[#F9FF96] p-10 items-center md:items-stretch rounded-2xl">
        ...
        <div>
          ...
          <ul className="font-bold md:text-2xl text-xl md:my-10 space-y-1 leading-tight">
  ...
  },
  {
    id: 2,
    title: "TESTING",
    content: (<div className=" text-black  flex flex-col md:flex-row gap-10 text-nowrap bg-[#9091FB] p-10 items-center md:items-stretch rounded-2xl">
      <div className="flex flex-col w-full md:w-2/3 space-y-8">
      <div>
  ...
  },
  {
    id: 3,
    title: "OPTIMIZATION",
    content: (<div className=" text-black  flex flex-col md:flex-row gap-10 text-nowrap bg-[#62D598] p-10 items-center md:items-stretch rounded-2xl">
      <div className="flex flex-col w-full md:w-2/3 space-y-8">
      <div>
        <h3 className="md:text-xl text-sm font-light uppercase">CONCIEGE CARE</h3>
        <ul className="font-bold md:text-2xl text-xl md:my-10 space-y-1 leading-tight">
