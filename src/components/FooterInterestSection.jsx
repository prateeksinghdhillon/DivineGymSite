      ...
      <div className="relative rounded-3xl overflow-hidden mx-4 my-8">
        <div className="relative z-10 p-8 md:p-12 lg:p-16 max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
            ...
            <a
              href="#waitlist"
              className="bg-yellow-200 text-gray-800 rounded-full py-2 px-5 inline-flex items-center justify-between w-50 group transition-all hover:shadow-lg"
            >
              <button
                onClick={openModal}
                className="flex items-center justify-between w-full transition-transform duration-300 ease-in-out">
                <span className="transition-transform duration-300 ease-in-out group-hover:translate-x-[-5px]">Join Now</span>
